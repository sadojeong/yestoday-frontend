    ...
    return (
        <div>
            ...
            <Modal show={show} onHide={handleClose} className=" right-6">
                <div className="mb-4 ">
                    <label className="block mt-4 mb-2 font-sans text-3xl text-center font-outline-1 text-[#69E0E8] shadow-black" >
                       Todo
                    </label>
                    <input
                        maxLength={20}
                    ...
                    <label className="block mt-4 mb-2 font-sans text-2xl text-center text-white font-outline-1" >
                        Description
                    </label>
                    <textarea className="w-full px-3 py-2 leading-tight text-black border rounded appearance-none h-60 focus:outline-none focus:shadow-outline"
